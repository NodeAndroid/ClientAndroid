 ...
 *
 * The simple way to use this class is to call {@link com.cometous.graduation.http.volley.toolbox.ImageLoader#get(String, com.cometous.graduation.http.volley.toolbox.ImageLoader.ImageListener)}
 * and to pass in the default image listener provided by
 * {@link com.cometous.graduation.http.volley.toolbox.ImageLoader#getImageListener(android.widget.ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
     ...
     * If the default was returned, the {@link com.cometous.graduation.http.volley.toolbox.ImageLoader} will be invoked when the
